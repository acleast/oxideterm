...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.6.3-blue" alt="버전">
...
버그 보고와 재현 가능한 회귀 문제를 우선 처리합니다. 기능 요청은 범위, 안전성, OxideTerm의 remote-server workspace 방향성과의 일치 여부를 기준으로 검토합니다.
