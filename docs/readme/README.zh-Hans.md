...
<p align="center">
  <strong>本地优先的 SSH 工作区：围绕一个远程节点使用 Shell、SFTP、端口转发、trzsz、轻量编辑和 BYOK AI。</strong>
  <br>
  <strong>零 Electron。零 OpenSSL。零遥测。零订阅。BYOK 优先。纯 Rust SSH。</strong>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/version-1.5.0-blue" alt="版本">
...
| 本地 Shell 和串口控制台也在同一套工作流里 | **混合引擎**：本地 PTY（zsh/bash/fish/pwsh/WSL2）、本地串口终端与远程 SSH 同窗共存，本地和远程工作不再割裂 |
