...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.5.0-blue" alt="バージョン">
...
| ローカル shell とシリアルコンソールも必要 | **統合ローカル shell**：zsh/bash/fish/pwsh/WSL2 とローカルシリアル端末を SSH セッションと並べて扱えるため、ローカル作業とリモート作業を同じ UI で進められます |
