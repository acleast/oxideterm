        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="rounded-lg border border-theme-border bg-theme-bg-card p-5">
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <Label className="text-theme-text">{t('settings_view.appearance.sidebar_auto_collapse')}</Label>
                            <p className="text-xs text-theme-text-muted mt-0.5">{t('settings_view.appearance.sidebar_auto_collapse_hint')}</p>
                        </div>
                        <button
                            type="button"
                            role="switch"
                            aria-checked={appearance.sidebarAutoCollapse}
                            onClick={() => updateAppearance('sidebarAutoCollapse', !appearance.sidebarAutoCollapse)}
                            className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-theme-accent focus-visible:ring-offset-2 ${appearance.sidebarAutoCollapse ? 'bg-theme-accent' : 'bg-theme-bg-hover'}`}
                        >
                            <span
                                className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-theme-text shadow-lg ring-0 transition duration-200 ease-in-out ${appearance.sidebarAutoCollapse ? 'translate-x-4' : 'translate-x-0'}`}
                            />
                        </button>
                    </div>
                </div>
